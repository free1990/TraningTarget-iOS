...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "BFKit/BFKit/Languages/vi.lproj"
  install_resource "BFKit/BFKit/Languages/zh-Hans.lproj"
  install_resource "BFKit/BFKit/Languages/zh-Hant.lproj"
  ...
  install_resource "XHTwitterPaggingViewer/XHTwitterPaggingViewer/Assets"
fi
