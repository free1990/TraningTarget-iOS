...
{
    [scanLineLayer_ removeFromSuperlayer];
    
    float scanFrameWidth  = size.width;
    float scanFrameheight = size.height;
    ...
    scanLineLayer_.frame = CGRectMake(0, 0, scanWidth, image.size.height);
    scanLineLayer_.contents = (id)image.CGImage;
